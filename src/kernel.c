...
/* -O1 libultra functions (need per-file override to decompile) */
...
} /* decompiled in O1, needs -O1 */

INCLUDE_ASM("asm/nonmatchings/kernel", func_80009C90); /* decompiled in O1, needs -O1 */

INCLUDE_ASM("asm/nonmatchings/kernel", __osResetGlobalIntMask); /* decompiled in O1, needs -O1 */
